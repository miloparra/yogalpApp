<template>
  <section id="about" class="scroll-mt-24 mt-24 py-20">
    <div class="h-[calc(100vh-96px)] my-[-80px] grid grid-cols-3 overflow-hidden">
      <!-- Image -->
      <div class="col-span-2 bg-[#DB6437]">
        <img
          src="public/photo_yoga_ext.jpg"
          alt="Yoga"
          class="w-full h-full object-cover border-r-3 border-r-[#DB6437] border-b-3 border-b-[#DB6437] pr-6"
        />
      </div>

      <!-- Texte -->
      <div class="p-6 flex flex-col justify-center items-center">
        <div class="w-3/5 flex justify-center items-center text-7xl">
          Yogalp
        </div>
        <div class="w-3/5 flex justify-center items-center text-sm text-justify mt-15">
